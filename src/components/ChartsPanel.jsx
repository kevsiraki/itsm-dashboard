...
export default function ChartsPanel({ trendData, statusData, priorityData, deptData, chartGrid, chartTick, tooltipProps }) {
  return (
    <section className="panels">
        ...
        <div className="chart">
          <ResponsiveContainer width="100%" height={220}>
            <AreaChart data={trendData} margin={{ top: 8, right: 14, left: -10, bottom: 0 }}>
              ...
              <Legend />
              <Area type="monotone" dataKey="count" stroke="#0a84ff" fill="url(#volumeGlow)" name="Daily tickets" />
              <Line type="monotone" dataKey="ma" stroke="#30d158" strokeWidth={2} dot={false} name="3-day moving average" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
      ...
      <div className="panel left">
        <h3>Priority Backlog Profile</h3>
        <div className="chart">
          <ResponsiveContainer width="100%" height={220}>
